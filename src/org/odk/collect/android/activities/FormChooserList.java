...
public class FormChooserList extends ListActivity implements DiskSyncListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Get the text file
        File file = new File(sdcard,"allowedForms.txt");
        
        String where=FormsColumns.JR_FORM_ID+" IN (\"";
        try {
        ...
        where+="\")";
        Cursor c = managedQuery(FormsColumns.CONTENT_URI, null,where, null, sortOrder);
        //String form="Form_Four";
        //Cursor c = managedQuery(FormsColumns.CONTENT_URI, null, FormsColumns.JR_FORM_ID+"=\""+form+"\"", null, sortOrder);
        /* END ALLOW FORMS
         * 
         */
